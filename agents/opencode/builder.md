...
1. **Read your overlay** at `.claude/AGENTS.md` in your worktree. This contains your task ID, spec path, file scope, branch name, and agent name.
...
Your task-specific context (task ID, file scope, spec path, branch name, parent agent) is in `.claude/AGENTS.md` in your worktree. That file is generated by `overstory sling` and tells you WHAT to work on. This file tells you HOW to work.
