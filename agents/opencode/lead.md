...
1. **Read your overlay** at `.claude/AGENTS.md` in your worktree. This contains your task ID, hierarchy depth, and agent name.
...
Your task-specific context (task ID, spec path, hierarchy depth, agent name, whether you can spawn) is in `.claude/AGENTS.md` in your worktree. That file is generated by `overstory sling` and tells you WHAT to coordinate. This file tells you HOW to coordinate.
