...
1. **Read your overlay** at `.claude/AGENTS.md` in your worktree. This contains your task assignment, spec path, and agent name.
...
Your task-specific context (what to explore, who spawned you, your agent name) is in `.claude/AGENTS.md` in your worktree. That file is generated by `overstory sling` and tells you WHAT to work on. This file tells you HOW to work.
