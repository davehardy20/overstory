 ...
 *
 * Supports both Claude Code (.claude/settings.local.json) and
 * Opencode (.opencode/settings.json) platforms.
 */
...
Hooks target: .claude/settings.local.json (Claude Code) or .opencode/settings.json (Opencode)`;
