/**
 * Claude Code platform hooks management.
 *
 * Manages hooks configuration in .claude/settings.local.json for orchestrator features.
 */
...
export class ClaudeHooks implements IPlatformHooks {
	getConfigPath(): string {
		const configDir = getDefaultConfigDir("claude");
...
export function createClaudeHooks(): IPlatformHooks {
